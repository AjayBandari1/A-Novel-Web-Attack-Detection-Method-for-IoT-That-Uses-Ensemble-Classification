...
global allurls
allurls = 'C:/Users/ajay bandari/Downloads/1A novel web attack detection system for iot using ensemble classification/dataset/major.combined.csv' 
def logit1():
    allurls = 'C:/Users/ajay bandari/Downloads/1A novel web attack detection system for iot using ensemble classification/dataset/major.combined.csv'  # path to our all urls file
